...
export class ExamplePageComponent implements OnInit, OnChanges, OnDestroy {

  constructor() { 
    console.log('Ciclo de vida Angular: CONSTRUCTOR');
  ...
  ngOnInit(): void {
    console.log('Ciclo de vida Angular: ngOnInit');
  }

  ngOnChanges(): void{
    console.log('Ciclo de vida Angular: ngOnChanges');
  }
  ngOnDestroy(): void{
    console.log('Ciclo de vida Angular: ngOnDestroy');
  }
